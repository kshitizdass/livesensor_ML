...
from sensor.entity.artifact_entity import DataIgestionArtifact, DataValidationArtifact,DataTransformationArtifact
...
class TrainPipeline:
    ...
    def start_data_ingestion(self)-> DataIgestionArtifact:
        try:
    ...
    def start_data_validaton(self,data_ingestion_artifact:DataIgestionArtifact)->DataValidationArtifact:
